...
public class PolarBearAController : MonoBehaviour
{
    ...
    public Sprite pb1_swim_L, pb1_swim_R, pb1_walk_L, pb1_walk_R;
    public Sprite pb1_swim_oil_L, pb1_swim_oil_R, pb1_walk_oil_L, pb1_walk_oil_R;
    public Sprite pb1_walk_seal_L, pb1_walk_seal_R;
    public Sprite pb1_walk_oil_seal_L, pb1_walk_oil_seal_R;
        ...
        if (SpriteLR == 0)//L
        {
            if (OnIceWater == 0|| OnIceWater == 2)//Ice
            {
                if (TouchedOil == false)
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_walk_L;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_walk_seal_L;
                    }
                }
                else
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_walk_oil_L;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_walk_oil_seal_L;
                    }
                }
            }
            else if(OnIceWater == 1)//Water
            {
                if (TouchedOil == false)
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_swim_L;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_swim_L;
                ...
                else
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_swim_oil_L;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_swim_oil_L;
        ...
        else if(SpriteLR==1)//R
        {
            if (OnIceWater == 0|| OnIceWater == 2)//Ice
            {
                if (TouchedOil == false)
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_walk_R;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_walk_seal_R;
                    }
                }
                else
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_walk_oil_R;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_walk_oil_seal_R;
                    }
                }
            }
            else if (OnIceWater == 1)//Water
            {
                if (TouchedOil == false)
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_swim_R;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_swim_R;
                ...
                else
                {
                    if (EatingSeal == false)
                    {
                        spriteRenderer.sprite = pb1_swim_oil_R;
                    }
                    else
                    {
                        spriteRenderer.sprite = pb1_swim_oil_R;
